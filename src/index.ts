...
export interface OwnProps {
  /** Initial style to be applied on the element when it is beneath or within the viewport. (Default: { opacity: 0, visibility: "hidden" }) */
  initialStyle: CSSProperties;
  /** Style to be applied on the element when it intersects with the top of the viewport. (default: { opacity: 1, visibility: "visible" }) */
  ...
  top?: number;
  /** Disconnect the IntersectionObserver after one intersection. */
  once?: boolean;
